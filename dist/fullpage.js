...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        */
        function moveSectionUp(){
            ...
            if (!prev && (options.loopTop || options.continuousVertical)) {
                //prev = last($(SECTION_SEL)); can toggle for continuous loop
            }
            var save
            if (prev != null) {
        ...
        */
        function styleSection(section, index){
            ...
            if (typeof options.sectionsBackground[index] !==  'undefined') {
                //css(section, {'background-image': 'url("'+ options.sectionsBackground[index]}) +'")';
            }
        ...
        * Adds a css3 transform property to the container class with or without animation depending on the animated param.
        */
           function transformBacks(translate3d, animated,back){
            if(animated){
                addAnimation(back);
            }else{
                removeAnimation(back);
            }

            css(back, getTransforms(translate3d));
            FP.test.translate3d = translate3d;

            //syncronously removing the class after the animation has been applied.
            setTimeout(function(){
                removeClass(back, NO_TRANSITION);
